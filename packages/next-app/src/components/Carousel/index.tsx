    ...
    return (
        <div className="relative h-full w-full overflow-hidden">
            <div className="top-[20%] h-[70%] absolute z-20 block flex w-full flex-col text-center">
                ...
                <p className="text-3xl inline hidden lg:block">“DunKain Pefume : For the Modern Gentleman and the Elegant Lady”</p>
                <div className="flex-1"></div>
                <p className="w-full m-auto font-semibold hidden lg:block" ><span className="w-[80%] m-auto block">Discover the captivating world of DunKain Pèume, where every fragrance is crafted to embody the perfect blend of sophistication and allure. For the distinguished gentleman, our scents evoke timeless elegance, while for the graceful woman, they inspire a touch of luxurious charm. Immerse yourself in a symphony of aromas that redefine the art of perfumery, bringing out the true essence of your individuality. With DunKain Pèume, step into a realm of refined beauty and unforgettable impressions.</span></p>
