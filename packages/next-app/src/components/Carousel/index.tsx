    ...
    return (
        <>
            <div className="top-[20%] h-[70%] absolute z-20 block flex w-full flex-col text-center">
                ...
                <p className="w-full m-auto font-semibold expand-background" ><span className="w-[80%] m-auto block">Discover the captivating world of DunKain Pèume, where every fragrance is crafted to embody the perfect blend of sophistication and allure. For the distinguished gentleman, our scents evoke timeless elegance, while for the graceful woman, they inspire a touch of luxurious charm. Immerse yourself in a symphony of aromas that redefine the art of perfumery, bringing out the true essence of your individuality. With DunKain Pèume, step into a realm of refined beauty and unforgettable impressions.</span></p>
                <a href="#main-content"><button className="btn glass w-1/5 h-[60px] m-auto mt-3">DISCOVER</button></a>
            </div>
            <Swiper
            ...
            >
                <SwiperSlide>
                    <img src="images/C2.jpg" alt="Slide 1" style={{ width: '100%', height: '100%' }} />
                </SwiperSlide>
                <SwiperSlide>
                    <img src="images/C4.jpg" alt="Slide 2" style={{ width: '100%', height: '100%' }} />
                </SwiperSlide>
                <SwiperSlide>
