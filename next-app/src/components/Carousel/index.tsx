    ...
    return (
        <div className="relative h-screen w-full overflow-hidden">
            <div className="top-[30%] h-[60%] absolute z-20 block flex w-full flex-col text-center">
                ...
                <p className="w-full m-auto font-semibold hidden lg:block expand-background" ><span className="w-[80%] m-auto block">Discover the captivating world of DunKain Pèume, where every fragrance is crafted to embody the perfect blend of sophistication and allure.</span></p>
